...
- `.claude/skills/common/scripts/step1/fetch_html_with_useragent.sh` - User-Agent付きHTMLフェッチ（中小企業庁など）
- `.claude/skills/common/scripts/step1/make_absolute_urls.py` - PDFリンクの絶対URL化
